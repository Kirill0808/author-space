      ...
      <div className="container mx-auto flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row px-4 text-center md:text-left">
        <div className="flex flex-col gap-2">
          <p className="text-sm leading-loose text-muted-foreground">
            Разработано для платформы Author Space.
          </p>
        ...
        <div className="flex items-center gap-4 text-sm text-muted-foreground">
          <Link href="#" className="hover:underline underline-offset-4">Условия</Link>
          <Link href="#" className="hover:underline underline-offset-4">Приватность</Link>
        </div>
      </div>
    </footer>
  )
